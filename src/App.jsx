...
function App() {
  return (
    <div className="relative overflow-x-hidden min-h-screen w-full bg-offwhite">
      <BrowserRouter>
        <NavBar />
        <Routes>
      ...
      <div className="-z-0 absolute top-0 left-0 bottom-0 right-0 max-h-full overflow-hidden bg-offwhite/40">
